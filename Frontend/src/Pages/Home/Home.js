      ...
      <Box className='searchBar'>
        ...
        <Box className='searchBox'>
         ...
         <Box>
            ...
            <Menu>
            <MenuButton as={Button} rightIcon={<ChevronDownIcon />} background=" #FFCCOO">
              Add a Vehicle
            </MenuButton>
            <MenuList >
          ...
          <Box>
          <Input placeholder='What part do you need Today?' width='595px' marginTop="5px" border="1px solid" />
          <Box>
        ...
        <Box> <FaSearch className='iconS'/></Box>
        <Box>3</Box>
        <Box>4</Box>
        ...
        <Box className='hoverLine'>
          ...
          <Box marginTop="10px" color="red.300">Special Offers</Box>
        ...
        <Box className='Valvoline'>
          <Box>
            <Heading fontSize="48px" width="600px" marginTop="50px" marginLeft="20px">
              Valvoline Oil Change Bundles
            </Heading>
            <Heading fontSize="20px"  marginTop="20px" marginLeft="20px" width="600px">
             Full Synthetic Starting at $39.99 + FREE Gumout Regane Fuel System Cleaner
            </Heading>
          ...
          <Box>
            <Image src="https://shop.advanceautoparts.com/wcsstore/CVWEB/Attachment/staticbusinesscontent/image/2022/11/Redesign_HP-Hero-eSpot-DESKTOP-745X308_Winter_2022.jpg" height="320px"/>
            </Box>        
        </Box>
